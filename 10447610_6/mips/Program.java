...
public class Program {
    ...
    public void insertPrologue(int pos, int frameSize)
    {
        ...
        prologue.add("addi $sp, $sp, " + -1*frameSize);
    ...
    {
        s.println("crxfunction.printInt:");
    ...
    {
        s.println("crxfunction.printBool:");
        s.println("lw $a0, 0($sp)");
    ...
    {
        s.println("crxfunction.printFloat:");
    ...
    {
        s.println("crxfunction.readFloat:");
